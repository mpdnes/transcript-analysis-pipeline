...
function gen_plot_of_words_for_bootstrapping_v05()
FS = 24;
MS = 10;
    ...
    class_labels = { 'Meh', 'Unimportant', 'Important' };
...
function guess = run_classifier( n_word_length, n_occurrances )

    classifier_slope        = -4.35;
    classifier_intercept    = 30.067;

    point_above_line        = n_occurrances - (n_word_length*classifier_slope + classifier_intercept);

    guess = point_above_line > 0;
